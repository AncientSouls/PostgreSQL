...
function mixin(superClass) {
    return class PostgresTracking extends superClass {
        ...
        tracked(item) {
            const _super = name => super[name];
            return __awaiter(this, void 0, void 0, function* () {
                const inserted = yield this.client.query(`insert into ${this.trackingTriggers.liveQueriesTableName} (fetchQuery, liveQuery, channel) values ($1, $2, '${this.id}') returning id;`, [
        ...
        untracked(item) {
            const _super = name => super[name];
            return __awaiter(this, void 0, void 0, function* () {
                yield this.client.query(`delete from ${this.trackingTriggers.liveQueriesTableName} where id = ${item.query.liveQueryId};`);
